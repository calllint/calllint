...
COMMANDS
  ...
  scan --agent <type>  Discover and scan a specific agent (cursor, claude-code, claude-desktop, vscode, windsurf, workbuddy, qwen-code, cline, kiro, gemini-cli, codex, openclaw, opencode)
...
SCAN OPTIONS
  ...
  --auto             Discover and scan every agent config CallLint can find (see --agent for the list)
