...
- **R3+** — diagnostics, prompt-surface depth, and the SARIF dogfood demo repo.

(npm publishing is already done: `calllint@0.3.0-preview.1` is on the public
registry — see [../PROJECT_STATUS.md](../PROJECT_STATUS.md).)
